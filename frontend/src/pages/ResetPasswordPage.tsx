...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    ...
    void authService
      ...
      .then(() => setError(""))
      .catch((caught) => setError(caught instanceof Error ? caught.message : "El link no es válido o expiró"))
  ...
  return (
    <AuthShell title="Resetear contraseña" description="Creá una contraseña segura para volver a ingresar.">
      {checking ? (
        <p className="rounded-xl bg-secondary p-3 text-sm font-semibold">Validando link...</p>
      ) : (
