...
import type { CheckoutPayload, CheckoutSummary, DeliveryMethod } from "@/types/order";
...
export default function CheckoutPage() {
  ...
  const payload = (): CheckoutPayload => ({
    ...
    customer,
    items,
    ...(deliveryMethod === "SHIPPING" ? { address: { ...address, recipient: address.recipient || customer.name, phone: address.phone || customer.phone } } : {}),
  });
  ...
  }, [deliveryMethod, customer.phone, address.city, address.street, cart.items.length]);
