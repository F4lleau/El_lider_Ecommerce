...
export default function CheckoutPage() {
  ...
  if (!cart.items.length) {
    return <div className="section-shell"><div className="empty-state mx-auto max-w-xl"><h1 className="section-title">Tu carrito está vacío</h1><p className="mt-3 text-muted-foreground">Agregá productos antes de iniciar el checkout.</p><Button className="mt-5" asChild><Link to="/productos">Ver productos</Link></Button></div></div>;
  }
