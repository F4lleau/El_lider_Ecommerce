...
El sistema permite navegación pública del catálogo, carrito público, checkout como invitado o usuario registrado, pagos online, retiro en sucursal, envío a domicilio, seguimiento de pedidos y administración privada de productos, categorías, precios, pedidos y contenido editable.
...
Puede navegar el catálogo, agregar productos al carrito y comprar sin iniciar sesión.
