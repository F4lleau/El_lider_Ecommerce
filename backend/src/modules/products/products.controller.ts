...
import { createProductSchema, productIdParamsSchema, productSlugParamsSchema, updatePriceSchema, updateProductSchema, updateStockSchema } from "./products.schema.js";
...
export const productsController = {
  ...
  listAdmin: asyncHandler(async (_req: Request, res: Response) => ok(res, await productsService.listAdmin())),
